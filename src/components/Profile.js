...
export const Profile = ({ token, tk }) => {
    useEffect(() => {
        async function getProfile() {
            try {
                let res = await axios.get("https://tempusapi.herokuapp.com/db/profile", {
                    headers: {
        ...
        async function getRecomm() {
            try {
                let res = await axios.get("https://tempusapi.herokuapp.com/db/recomm", {
                    headers: {
                        authorization: `bearer ${tk}`
                    }
                })
        ...
        async function getTime() {
            try {
                let res = await axios.get("https://tempusapi.herokuapp.com/db/total_time", {
                    headers: {
                        authorization: `bearer ${tk}`
                    }
                })
